...
libnvc::nvim_widget::nvim_widget(size_t width, size_t height)
    : m_currboard(std::make_unique<libnvc::board>(width, heigth))
    , m_backboard()
{}

void libnvc::nvim_widget::on_put(const std::string &str)
{
